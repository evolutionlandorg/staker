// hevm: flattened sources of src/StakingRewardsSingle.sol
...
contract StakingRewardsSingle is IStakingRewards, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function stakeWithPermit(uint256 amount, uint deadline, uint8 v, bytes32 r, bytes32 s) external nonReentrant updateReward(msg.sender) {
        ...
        // permit
        IUniswapV2ERC20_2(address(stakingToken)).permit(msg.sender, address(this), amount, deadline, v, r, s);
    ...
    function changeRewardsDistribution(address _newRewardsDistribution) external onlyRewardsDistribution {
        rewardsDistribution = _newRewardsDistribution;
    }
